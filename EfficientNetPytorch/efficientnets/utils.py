...
# Parameters for the entire model (stem, all blocks, head)
...
def round_repeats(repeats, global_params):
    """Round number of filters based on the depth multiplier"""
...
def get_same_padding_conv2d(image_size=None):
    """
    Choose static padding if you have specified an image size, or dynamic padding otherwise.
...
def efficientnet(width_coefficient=None, depth_coefficient=None, dropout_rate=0.2,
    ...
    block_args = BlockDecoder.decode(block_args)
...
def get_model_params(model_name, override_params):
    ...
    if model_name.startswith('efficientnet'):
        ...
        raise NotImplementedError(f'model name is not predefined: {model_name}')
